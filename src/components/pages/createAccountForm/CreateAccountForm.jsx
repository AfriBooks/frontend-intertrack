    ...
    const getProducts = items.map((product) => {
        return (
            <div className="register-card--div-two">
                <div
                    key={product._id}
                    className="createAccountForm-card-product-div-two"
                >
                    <div className="createAccountForm-card--img--div">
                        <img
                            className="createAccountForm-card--img"
                            src={product.cover}
                            alt=""
                        />
                    </div>
            ...
            <div className="createAccountForm-main-div-two">
                    ...
                    <div className="createAccountForm-div-two">
                        <div className="createAccountForm-div-inner-two">
                            <div className="createAccountForm-h3-div-two">
                                <h3 className="createAccountForm-h3-two">
                                    Create account
                                </h3>
                                <p className="createAccountForm-para-1-two">
                            ...
                            <form
                                ...
                                className="createAccountForm-form-two"
                            >
                                <label id="createAccountForm-name-label-two">
                                    Name
                                </label>
                                <br />
                                <input
                                    className="createAccountForm-input-two"
                                    type="text"
                                    placeholder="name"
                                    onChange={(e) =>
                                        setUser({
                                ...
                                <label
                                    className="createAccountForm-email-label-two"
                                    id="email-label"
                                >
                                    Email address
                                </label>
                                ...
                                <label
                                    className="createAccountForm-password-label-two"
                                    id="password-label"
                                >
                                    Password
                                </label>
                                ...
                                <button className="createAccountForm-sign-up-btn-two" disabled={loading}>
                                    {loading ? "Please wait..." : "Sign Up"}
                                </button>
                            </form>

                            <p className="createAccountForm-para-2-two">
                                Already have an account?
                                <Link to="/sign-in-two"> Login </Link>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="createAccountForm-div-right-two">
                    <div className="createAccountForm-card-div-two">
                        {getProducts.length ? (
                            <div className="register-card-section-two">
                                {getProducts}
                            </div>
                        ) : (
                            ""
